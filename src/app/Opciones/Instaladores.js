...
const Headers = [
    {title:'Instalador', field:'instalador'},
];
    ...
    useEffect(
        ()=>{
            async function handleData(){
                const response = await fetch('/Instaladores')
                            ...
                            editable={{  
                                ...
                                new Promise(resolve => {
                                    ...
                                    .then(result => {
                                        if(result.status)
                                        {
                                            ...
                                            handleAdd(result);
                                            enqueueSnackbar('INSTALADOR AGREGADO', { variant:'success'})
                                            resolve();
                                        }
                                    })
                                }),
                                ...
                                new Promise(resolve => {
                                    ...
                                    .then(result => {
                                        if(result.message)
                                        {
                                            enqueueSnackbar('INSTALADOR EDITADO', { variant:'success'});
