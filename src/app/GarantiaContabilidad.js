...
import {
  ...
  import { Page, Text, View, Document, StyleSheet, Font, usePDF } from '@react-pdf/renderer';
    ...
    const headCellsColumn = [
        ...
        { id: 'isRegarantia', numeric: false, disablePadding: false, label: 'ReGarantia', show:true, fixed:false, width:100, num:1 },
        { id: 'Creacion', numeric: false, disablePadding: false, label: 'Creacion', show:true, fixed:false, width:100, num:2 },
        { id: 'numpro', numeric: true, disablePadding: false, label: 'PPTO', show:true, fixed:false, width:80, num:3 },
        { id: 'OT', numeric: true, disablePadding: false, label: 'O.T.', show:true, fixed:false, width:80 , num:4 },
        { id: 'Cliente', numeric: true, disablePadding: false, label: 'Cliente', show:true, fixed:false, width:300, num:5  },          
        { id: 'Proyecto', numeric: false, disablePadding: false, label: 'Proyecto', show:true, fixed:false, width:300, num:6  },
        { id: 'Ejecutiva', numeric: false, disablePadding: false, label: 'Ejecutiva', show:true, fixed:false, width:200, num:7  },
        { id: 'CanElem', numeric: true, disablePadding: false, label: 'Cantidad', show:true, fixed:false, width:100, num:8 }, 
        { id: 'TipTra', numeric: false, disablePadding: false, label: 'Tipo Trabajo', show:true, fixed:false, width:210, num:9  },  
        { id: 'MotGar', numeric: false, disablePadding: false, label: 'Motivo Garantia', show:true, fixed:false, width:200, num:10  },
        { id: 'TipGar', numeric: false, disablePadding: false, label: 'Tipo Garantia', show:true, fixed:false, width:120, num:11 },
        { id: 'Fotos', numeric: false, disablePadding: false, label: 'Fotos', show:true, fixed:false, width:100, num:12 },
        { id: 'FotosFirst', numeric: false, disablePadding: false, label: 'Fotos First', show:true, fixed:false, width:100, num:13 },
        { id: 'ObservacionGar', numeric: false, disablePadding: false, label: 'Observacion Ventas', show:true, fixed:false, width:200, num:14  },
        { id: 'FecIns', numeric: false, disablePadding: false, label: 'Fec. Instalacion', show:true, fixed:false, width:170, num:15  },
        { id: 'FecVen', numeric: false, disablePadding: false, label: 'Fec. Vencimiento', show:true, fixed:false, width:170, num:16  },
        { id: 'Status', numeric: false, disablePadding: false, label: 'Status', show:true, fixed:false, width:90, num:17  },
        { id: 'FechaInicio', numeric: false, disablePadding: false, label: 'Fecha Inicio', show:true, fixed:false, width:200, num:18  },
        { id: 'FechaTermino', numeric: false, disablePadding: false, label: 'Fecha Acuerdo', show:true, fixed:false, width:200, num:19  },
        { id: 'FechaTerminoReal', numeric: false, disablePadding: false, label: 'Fecha Termino', show:true, fixed:false, width:200, num:20  },
        { id: 'ObservacionSuper', numeric: false, disablePadding: false, label: 'Observacion Supervisor', show:true, fixed:false, width:240, num:21  },
        { id: 'Cadena', numeric: false, disablePadding: false, label: 'Cadena', show:true, fixed:false, width:100, num:22  },
        { id: 'Local', numeric: false, disablePadding: false, label: 'Local', show:true, fixed:false, width:100, num:23 },   
        { id: 'Codigo', numeric: false, disablePadding: false, label: 'Codigo', show:true, fixed:false, width:100, num:24  },
    ];
    ...
    const TdYounet = memo(((props)=>{
        const { minWidth, width, headCells, headCell, valueInfo, fotos, fotosFirst, fixed, color, anulado, fechas, observacionSuper, HandleSaveRows, isRegarantia, } = props
        const [ leftValue, setLeftValue ] = useState('0px');
    ...
    /*****************************************************/
        ...
        useEffect(()=>{
            setOpen(false); 
            setHeaderWord('Garantia/GarantiaContabilidad');
            fetch('/DataGarantias')
            .then(res=>res.json())
            .then(dataInf => {
                if(dataInf.status){
        ...
        return(
            <Grid container style={{width:'100%'}}>
                ...
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{display:'block'}}>
                    <Toolbar >   
                        <div style={{marginRight:30, fontSize:20}}>Garantia Contabilidad/Bodega</div>
    ...
    function GarantiaContabilidad(props) {
        return (
    ...
    export default GarantiaContabilidad;