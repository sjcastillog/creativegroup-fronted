...
import { DragDropContext } from 'react-beautiful-dnd';
    ...
    const headCellsColumn = [
        ...
        { id: 'numFac', numeric: true, disablePadding: false, label: 'NO. FACTURACION', show:true, fixed:false, width:180, num:3, align:'left', fontSize:'10px', bolder:false, type:'text'  },
        { id: 'Ejecutiva', numeric: false, disablePadding: false, label: 'EJECUTIVA', show:true, fixed:false, width:150, num:4, align:'center', fontSize:'10px', bolder:false , type:'text'   },
        { id: 'Cliente', numeric: false, disablePadding: false, label: 'CLIENTE', show:true, fixed:false, width:200, num:5 , align:'left', fontSize:'10px', bolder:false , type:'text'   },   
        ...
        { id: 'refPPTO', numeric: true, disablePadding: false, label: 'REF. PPTO', show:true, fixed:false, width:110, num:7, align:'center', fontSize:'10px', bolder:false , type:'number'   },
        { id: 'subFac', numeric: false, disablePadding: false, label: 'SUB. FACTURA', show:true, fixed:false, width:140, num:8, align:'left', fontSize:'10px', bolder:false, type:'text'  },
        { id: 'ivaFac', numeric: false, disablePadding: false, label: 'IVA FACTURA', show:true, fixed:false, width:140, num:9, align:'left', fontSize:'10px', bolder:false, type:'text'  },
        { id: 'totFac', numeric: false, disablePadding: false, label: 'TOTAL FACTURA', show:true, fixed:false, width:140, num:10, align:'left', fontSize:'10px', bolder:false, type:'text'  },
        { id: 'Proyecto', numeric: false, disablePadding: false, label: 'PROYECTO', show:true, fixed:false, width:400, num:11, align:'left', fontSize:'9px', bolder:false , type:'text'    },
        { id: 'Usuario', numeric: false, disablePadding: false, label: 'USUARIO', show:true, fixed:false, width:160, num:12, align:'left', fontSize:'10px', bolder:false , type:'text'   },
        { id: 'numproAnio', numeric: true, disablePadding: false, label: 'PROFORMA AÑO', show:true, fixed:false, width:150, num:13, align:'left', fontSize:'10px', bolder:false, type:'number' },
        { id: 'numproMes', numeric: false, disablePadding: false, label: 'PROFORMA MES', show:true, fixed:false, width:150, num:14, align:'left', fontSize:'10px', bolder:false , type:'text'    },
        { id: 'numproDate', numeric: false, disablePadding: false, label: 'PROFORMA FECHA', show:true, fixed:false, width:160, num:15, align:'left', fontSize:'9px', bolder:false , type:'date'    },
        { id: 'Status', numeric: false, disablePadding: false, label: 'STATUS', show:true, fixed:false, width:110, num:16, align:'left', fontSize:'10px', bolder:false , type:'text'   },
        ...
        { id: 'ot', numeric: true, disablePadding: false, label: 'N° O.T.', show:true, fixed:false, width:100, num:19, align:'left', fontSize:'10px', bolder:false, type:'text' },
        { id: 'anioOt', numeric: true, disablePadding: false, label: 'AÑO O.T.', show:true, fixed:false, width:100, num:20, align:'left', fontSize:'10px', bolder:false, type:'number' },
        { id: 'mesOt', numeric: false, disablePadding: false, label: 'MES O.T.', show:true, fixed:false, width:140, num:21, align:'left', fontSize:'10px', bolder:false, type:'text' },
        { id: 'otDate', numeric: false, disablePadding: false, label: 'FECHA O.T.', show:true, fixed:false, width:100, num:22, align:'left', fontSize:'10px', bolder:false, type:'date' },
        { id: 'costot', numeric: true, disablePadding: false, label: 'COST. TOTAL', show:true, fixed:false, width:110, num:23, align:'center', fontSize:'10px', bolder:false , type:'text'   },
        { id: 'destot', numeric: true, disablePadding: false, label: 'DESC. TOTAL', show:true, fixed:false, width:110, num:24, align:'center', fontSize:'10px', bolder:false , type:'text'   },
        { id: 'costotnet', numeric: true, disablePadding: false, label: 'COST. TOTAL NETO', show:true, fixed:false, width:140, num:25, align:'center', fontSize:'10px', bolder:false , type:'text'   },
        { id: 'oc', numeric: false, disablePadding: false, label: 'O.C.', show:true, fixed:false, width:100, num:26, align:'left', fontSize:'10px', bolder:false, type:'text'    },
        { id: 'anioOc', numeric: true, disablePadding: false, label: 'AÑO O.C.', show:true, fixed:false, width:100, num:27, align:'left', fontSize:'10px', bolder:false, type:'number' },
        { id: 'mesOc', numeric: false, disablePadding: false, label: 'MES O.C.', show:true, fixed:false, width:100, num:28, align:'left', fontSize:'10px', bolder:false, type:'text' },
        { id: 'dateOc', numeric: false, disablePadding: false, label: 'FECHA O.C.', show:true, fixed:false, width:100, num:29, align:'left', fontSize:'10px', bolder:false, type:'date' },
        { id: 'migo', numeric: false, disablePadding: false, label: 'MIGO', show:true, fixed:false, width:100, num:30, align:'left', fontSize:'10px', bolder:false, type:'text'    },
        { id: 'anioMigo', numeric: true, disablePadding: false, label: 'AÑO MIGO', show:true, fixed:false, width:100, num:31, align:'left', fontSize:'10px', bolder:false, type:'text' },
        { id: 'mesMigo', numeric: false, disablePadding: false, label: 'MES MIGO', show:true, fixed:false, width:100, num:32, align:'left', fontSize:'10px', bolder:false, type:'text' },
        { id: 'migoDate', numeric: false, disablePadding: false, label: 'FECHA MIGO', show:true, fixed:false, width:100, num:33, align:'left', fontSize:'10px', bolder:false, type:'date' },
    ...
    function EnhancedTableHead(props) {
        ...
        const { classes, order, orderBy, onRequestSort, headCells, selectionArr } = props;
    ...
    function EnhancedTableHeadSum(props) {
        ...
        useEffect(()=>{
            ...
            for(const x in arr){
                ...
                valIva =        parseFloat(valSub) + parseFloat(ivaFac);
                valTot =        parseFloat(valSub) + parseFloat(totFac);
            }
    ...
    const Roow = memo((props)=>{
        const { row, index, headCells, HandleClickRow, HandleSaveRows, selectionArr } = props;
            ...
            <TrYounetStyled key={`fila-${row.idGeneral}`}  selected={statusRow}>
                <TdYounetStyled minWidth={100} width={100}>
                    <Grid container justify='center'>
                        ...
                        <Grid item style={{display:'flex', justifyContent:'center', alignItems:'center', alignContent:'center'}}>
                            <IconButton onClick={handleAnular} size='small' style={{marginTop:-10}}> 
    ...
    const Invoiced = (props)=>{
        ...
        const [ headersColumn, setHeadersColumn ] = useState(()=>{
            try{
                if(window.localStorage.getItem('headersInvoiced')){
                    const headersStorage = window.localStorage.getItem('headersInvoiced') ;
        ...
        useEffect(()=>{
            const handleUseEffect = async ()=>{
                ...
                resultOp.forEach((el,index)=>{
                    ...
                    objeto.formularios = objetoFil.formularios;
                    ...
                    objeto.subFac     = isNaN(objetoFil.subFac) ? 0 : objetoFil.subFac ;
                    ...
                    if(objeto.numFac !== ''){
                        if(objeto.numFac !== null){
                            if(objeto.numFac !== undefined){
                                arr.push(objeto);
                            }
                        }
                    }
        ...
        const HandleChangeSwitch = (e)=>{
            ...
            window.localStorage.setItem('headersInvoiced', JSON.stringify(arrMap))
        };
        ...
        const HandleSaveRows = useCallback((row)=>{
            const arrMax = [...rows];
            const arrNico = arrMax.map(value=>{
                if(value.numpro === row.numpro){
                    const objeto = {...row};
                    objeto.Status = 'Anulado';
                    objeto.RefPPTO = row.OpNew;
                    return objeto;
                }else{
                    return value
                }
            ...
            objeto.numpro = row.OpNew;
            objeto.RefPPTO = row.numpro;
            objeto.idGeneral =`${row.idGeneral}_${row.OpNew}`
            arrNico.unshift(objeto);
            setRows(arrNico);
        ...
        const HandleProcessHeaders = useCallback((dataHeadersStyle)=>{
            ...
            window.localStorage.setItem('headersInvoiced', JSON.stringify(headersResultStyles))
            setSavingHeaders(true);
        ...
        return(
            <Grid container style={{width:'100%'}}>
                ...
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{display:'block'}}>
                    <Toolbar >   
                        <div style={{marginRight:30, fontSize:20}}>PPTOS. FACTURADOS</div>
